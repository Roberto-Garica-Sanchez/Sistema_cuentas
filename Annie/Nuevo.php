...
if($_POST['name2set']=='Modificar'){//proceso de modificado
	if(!empty($_POST['Carta1']))$_POST['n_c']= $libre_v2->compro($_POST['Carta1'],'ID_G'	,'N_Cuenta'	,$consu_folio,$conexion,$phpv,'');
...
*/
	...
	######################## Interface de ingreso 	
		echo "<div id='general_datos' style='display: block;float: right; width: max-content; position: relative;background: #0f4c75;padding: 5px;top: 0px; box-shadow: inset 0px 0px 5px black;'>";
			##celdas
				echo"<div>";
	...
	######################## Cuentas Actual 	
	echo "<div id='gene_actua' class='gene_actua' style='display: block;position: relative;background: #28336985;padding: 5px;width: 640px;float: right;'>";	
...
*/
	...
	######################## Combustible 
		echo "<div id='gene_combustible'  class='gene_combustible'  style='display: block;float: right;'>";
			...
			/*
				...
				IF(empty($dif4))$dif4='';
			*/
				echo"<div style='float: left;position: relative;width: min-content; background: deepskyblue'>";
			...
			/*
				...
				echo $libre_v2->input2('text','','','Presio','background: #343434; color: #0075ff;',"",'disabled','');
				echo $libre_v2->input2('text','presio_d','',$_POST['presio_d'],"background: white; color: black;box-shadow: inset 0px 0px 8px #0072fd;",'presio_d',"placeholder='Costo' onkeyup='calcula_update();calcu_combustible();'onkeypress='return valida_n(event,crome_i)' maxlength='10'",'');
				echo $libre_v2->input2('text','','','Inicio'				,			''	,''		,"disabled",'');
				echo $libre_v2->input2('text','crome_i','',$_POST['crome_i']	,'background: white;color: black;box-shadow: inset 0px 0px 8px #0072fd;'	,'crome_i',"onkeyup='calcula_update();calcu_combustible();'onkeypress='return valida_n(event,crome_f)' maxlength='15'",'');	
				echo $libre_v2->input2('text','','','Final'				,			'',''		,"disabled",'');
				echo $libre_v2->input2('text','crome_f','',$_POST['crome_f']	,'background: white;color: black;box-shadow: inset 0px 0px 8px #0072fd;'	,'crome_f',"onkeyup='calcula_update();calcu_combustible();'onkeypress='return valida_n(event)' maxlength='15'",'');
				echo $libre_v2->input2('text','','','Despachado Lts'				,''			,''		,"disabled",'');
				echo $libre_v2->input2('text','crome_t','',$_POST['crome_t'],'color: #a4c1e3;'	,'crome_t',"disabled",'');
				echo $libre_v2->input2('text','','','Costo'				,''				,''		,"disabled",'');
				echo $libre_v2->input2('text','crome_t','',"$".$libre_v2->formato_num($_POST['precio_de_litros_consumidos'])	,'color: #a4c1e3;'	,'crome_t',"disabled",'');
				echo"<div style='float: left;position: relative;width: 210px;'>";
					echo $libre_v2->input2('text','','','Kilometrajes'		,'margin: 0px .5px; width: 100%; text-align: center; color: #a4c1e3;',"",'disabled','');
					echo $libre_v2->input2('text','','','Inicio'				,''				,''		,"disabled",'');
					echo $libre_v2->input2('text','','',$_POST['km_i']." Km"	,'color: #0075ff;'	,'',"disabled ",'');
					echo $libre_v2->input2('text','','','Final'				,''				,''		,"disabled",'');
					echo $libre_v2->input2('text','','',$_POST['km_f']." Km"	,'color: #0075ff;'	,'',"disabled",'');
					echo $libre_v2->input2('text','','',' Recoridos','','',"disabled",'');
					echo $libre_v2->input2('text','','',$_POST['Total_km']." Km",'','Total_km',"disabled",'');			
					echo $libre_v2->input2('text','','','Km/Lts','',"",'disabled','');
					echo $libre_v2->input2('text','','',$_POST['km_lts']." km/L",'','km_l','disabled','');
				echo"</div>";
					
					
					echo"</div>";
					//echo"<br>";
					//echo $libre_v2->input2($TYPE,'','','Total Litros','',"",'disabled');
					//echo $libre_v2->input2($TYPE,'','',$T_L,'',t_l,'disabled');
				*/
			echo "</div>";	
		echo "</div>";	
	...
	/*
		echo "<div id='gene_arrastre' class='gene_arrastre' style='display: block;'>";		
			...
			echo$libre_v5->input('button','','Relacion de cuentas','','Medio botone_n','','','width: 100%;');

			echo"<div style='width: 250px'>";	
				echo$libre_v5->input('button','','Cuentas Arrastrada','','Medio botone_n','','','width: 100%;');
				echo$libre_v5->input('button','','Carta Referencia','','Medio botone_n','','','width: 60%;');
				echo$libre_v5->input('button','','Saldo Arrastrado','','Celdas Medio botone_n ','','','width: 40%;');
				echo$libre_v5->input('button','','Saldo Arrastrado','','Celdas Medio botone_n ','','','width: 40%;');
	...
	######################## Cuentas Anteriores 
		echo "<div id='gene_list_arras' class='gene_list_arras'>";
			...
			echo "<div id	='divArrastrar' style='overflow-x: hidden;overflow-y: auto;height: 96px;position: relative;padding: 5px 0px;background: black;width: 275px;box-shadow: inset 0px 0px 8px #0073ff;'>";
				...
				if((!empty($_POST['chofer']))and($_POST['chofer']!='chofer')){
					...
					if($libre_v2->mysql_nu_ro		($consu5,$phpv)>0){
					...
					echo "Ningun Registro Encontrados";	
				}					
