					...
					/*
						#fecha inicio
							...
							echo"<div>";
								...
								echo $libre_v2->input2('text','D_i','',$_POST['D_i'],$style,'D_i','','');
								echo $libre_v2->input2('text','M_i','',$_POST['M_i'],$style,'M_i','','');
								echo $libre_v2->input2('text','A_i','',$_POST['A_i'],$style."width: 35px;",'A_i','','','');
							echo"</div>";
						#fecha final
							echo"<div>";				
								echo $libre_v2->input2('text','','',"Flecha Final","width: 100px; height: 17px;",'','disabled','botone_n');	
								echo $libre_v2->input2('text','D_f','',$_POST['D_f'],$style,'D_f','','');
								echo $libre_v2->input2('text','M_f','',$_POST['M_f'],$style,'M_f','','');
								echo $libre_v2->input2('text','A_f','',$_POST['A_f'],$style."width: 35px;",'A_f','','');
							echo"</div>";
							*/
					echo"</div>";
				#botones	
					echo"<div style='float:left;'>";
						...
						echo"<br>";
						echo $libre_v2->input2('button','','',"Analizar o Reparar",$style."width: 140px; height: 17px;",'','','botone_n');
						echo"<br>";
