...
function Calculadora_Annie_2020_06_29($array){
    ...
    */
        ...
        ####    Gastos Oficina 
            ...
            if(!empty($_POST['TOTAL3']))                            {$_POST['gastos_totales_flete']=$_POST['gastos_totales_flete']+$_POST['TOTAL3']; echo"->".-$_POST['TOTAL3'];}
            if(!empty($_POST['TOTAL9']))                            {$_POST['gastos_totales_flete']=$_POST['gastos_totales_flete']+$_POST['TOTAL9']; echo"->".$_POST['TOTAL9'];}
            if(!empty($_POST['gastos_de_flete']))                   {$_POST['gastos_totales_flete']=$_POST['gastos_totales_flete']+$_POST['gastos_de_flete']; echo"->".$_POST['gastos_de_flete'];}
            if(!empty($_POST['comicion_flete_completo_a_cliente'])) {$_POST['gastos_totales_flete']=$_POST['gastos_totales_flete']+$_POST['comicion_flete_completo_a_cliente'];echo"->".$_POST['comicion_flete_completo_a_cliente'];}
            if(!empty($_POST['precio_de_litros_consumidos']))       {$_POST['gastos_totales_flete']=$_POST['gastos_totales_flete']+$_POST['precio_de_litros_consumidos']; echo"->".$_POST['precio_de_litros_consumidos'];}
