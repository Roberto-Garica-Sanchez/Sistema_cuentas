		...
		echo"<div id='general_info' style='float: right;background: #05486cab;width: 220px;right: 0px;top: 0px;bottom: 5px;position: relative;color: white;'>";
			#### Informacion primaria
				echo"<div id='datos_info'>";
					...
					echo $libre_v5->input('text','Carta1',$_POST['Carta1'],'Carta1','botones_submenu','','onkeypress="return valida_n(event,Carta2)"',"width: 60%");
					
					echo $libre_v2->input2('text','','','Carta Porte 2'		,"width: 40%",''		,"disabled",'botone_n');
					echo $libre_v5->input('text','Carta2',$_POST['Carta2'],'Carta2','botones_submenu','','onkeypress="return valida_n(event,Carta3)"',"width: 60%");

					echo $libre_v2->input2('text','','','Carta Porte 3'		,"width: 40%",''		,"disabled",'botone_n');
					echo $libre_v5->input('text','Carta3',$_POST['Carta3'],'Carta3','botones_submenu','','onkeypress="return valida_n(event,Carta4)"',"width: 60%");
					
					echo $libre_v2->input2('text','','','Carta Porte 4'		,"width: 40%",''		,"disabled",'botone_n');
					echo $libre_v5->input('text','Carta4',$_POST['Carta4'],'Carta4','botones_submenu','','onkeypress="return valida_n(event,Fecha_Salida)"',"width: 60%");
					/*
						...
						echo $libre_v2->input3($folio,'Carta4','input','text'	,'width: 60%;'.$style_Carta4,'botones_submenu','','','onkeypress="return valida_n(event,Fecha_Salida)"','');
					*/
					echo $libre_v2->input2('text','','','Fecha Inicio'		,"width: 40%",'',"disabled",'botone_n','','','');
					#echo $libre_v2->input2('date','Fecha_Salida','',''		,"width: 60%",'',"",'botones_submenu','Fecha_Salida','onkeypress="return valida_n(event,Fecha_Llegada)"','');
					echo $libre_v5->input('date','Fecha_Salida',$_POST['Fecha_Salida'],'Fecha_Salida','botones_submenu','','onkeypress="return valida_n(event,Fecha_Llegada)"',"width: 60%");
					echo $libre_v2->input2('text','',''	,'Fecha Final'		,"width: 40%",'',"disabled",'botone_n','','','');
					#echo $libre_v2->input2('date','Fecha_Llegada','',''		,"width: 60%",'',"",'botones_submenu','Fecha_Llegada','onkeypress="return valida_n(event,KM_S)"','');
					echo $libre_v5->input('date','Fecha_Llegada',$_POST['Fecha_Llegada'],'Fecha_Llegada','botones_submenu','','onkeypress="return valida_n(event,KM_S)"',"width: 60%");

					echo $libre_v2->input2('text','','','Km Inicio'		,"width: 40%",''		,"disabled",'botone_n');
					echo $libre_v5->input('text','KM_S',$_POST['KM_S'],'KM_S','botones_submenu','','onkeypress="return valida_n(event,KM_E)"',"width: 60%");
					
					echo $libre_v2->input2('text','','','Km Final'		,"width: 40%",''		,"disabled",'botone_n');
					echo $libre_v5->input('text','KM_E',$_POST['KM_E'],'KM_E','botones_submenu','','onkeypress="return valida_n(event,Flete_R)"',"width: 60%");
					
					echo $libre_v2->input2('text','','','Km Final'		,"width: 40%",''		,"disabled",'botone_n');
					echo $libre_v5->input('text','Flete_R',$_POST['Flete_R'],'Flete_R','botones_submenu','','onkeypress="return valida_n(event)"',"width: 60%");
